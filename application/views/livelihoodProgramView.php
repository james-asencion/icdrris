...
<h7>Add Livelihood Resource</h7>
 <label for="target_recipients">Resources : </label><div class="span2"></div>
        ...
        <div class="btn btn-default btn-small submitNewLivelihoodResource">Add New Resource</div>
</div>
...
<div id="addNewProgramResourceModal" class="modal hide fade">
    <div class="modal-body">
        Quantity : <input type="text" name="resource_description" id="resource_description"/>
    </div>
    <div class="modal-footer">
        <a class="btn danger btnSubmit" id="confirmNewResource" >Submit</a>
        <a href="javascript:$('#addNewProgramResourceModal').modal('hide')" class="btn secondary">Cancel</a>
    </div>
</div>
