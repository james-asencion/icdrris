...
function initialize() {
    ...
    var html = "<form id='reportIncidentForm' method='POST' action='javascript:savePolygonData()'><table>" +
           ...
           // "<tr><td></td><td><input type='button' class='btn btn-success' value='Report Incident' onclick='savePolygonData()'/></td></tr>";
            "<tr><td></td><td><input type='button' class='btn btn-success' value='Report Incident' /></td></tr>";
