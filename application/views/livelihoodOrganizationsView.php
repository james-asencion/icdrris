...
<div id="membersTable" class="container" >
    ...
    <?php foreach ($organizations as $organization) {
                echo "<tr><td>".$organization->livelihood_organization_name."</td><td>".$organization->livelihood_organization_address."</td><td>".$organization->no_of_members."</td><td>".$organization->initial_income."</td><td>".$organization->livelihood_organization_status."</td><td>".$organization->date_established."</td><td>".$organization->business_activity_type."</td><td><a href=\"#\" class=\"confirm-delete\" data-name=\"".$organization->livelihood_organization_name."\" data-id=".$organization->livelihood_organization_id."><i class=\"icon-trash\"></i></a><a class=\"confirm-edit\" align=\"center\" href=viewLivelihoodOrganization?id=".$organization->livelihood_organization_id."><i class=\"icon-search\"></i></a></td></tr>";
    } ?>  
    </table>;
</div>
